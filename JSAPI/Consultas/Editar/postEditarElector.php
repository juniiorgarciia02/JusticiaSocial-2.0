...
if (isset($postdata) && !empty($postdata)) {
    ...
    $idelector = utf8_decode($datos->idelector);
    ...
    $sql = " UPDATE `electores` SET `nombre_ele`='$nombre',`apodo_ele`='$apodo',`cedula_ele`='$cedula',`telefono_ele`='$telefono' WHERE ID_ele = '$idelector' "; 
        // echo($sql);
